...
int main(){
   ...
   double max_par=0,max_primo=0,max_cubo=0,max_fatorial=0,max_fibo=0,max_quadrado=0,max_cria=0;
    ...
    for (i=0;i<10;i++){
        ...
        /* aqui é calculado o tempo total de execução da função, além de verificados o tempo máximo e mínimo. */
...
/* o tempo médio é calculado pegando a soma de todos os tempos de execução e edivindo pelo número de execuções, nesse caso 400*/
